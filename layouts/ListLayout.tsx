          ...
          <div className="hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto rounded bg-gray-50 pt-5 shadow-md dark:bg-gray-900/70 dark:shadow-gray-800/40 sm:flex">
            <div className="px-6 py-4">
              <button
                ...
                className={`${useTagStore.getState().selectedTag === '' ? 'text-heading-900 dark:text-heading-100' : 'text-gray-500 dark:text-gray-400'} font-bold uppercase`}
              >
                {t('all')}
              </button>
              <ul>{filteredTags}</ul>
                                  ...
                                  <button
                                    ...
                                    className={`${
                                      useTagStore.getState().selectedTag === t
                                        ? 'text-heading-900 dark:text-heading-100'
