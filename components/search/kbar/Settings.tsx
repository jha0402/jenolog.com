...
const Settings: React.FC<SettingsProps> = ({ t, handleThemeChange, handleLinkClick }) => (
  <>
    <div className="mb-5 ml-4 mt-5 flex flex-row items-center text-3xl font-semibold text-heading-900 dark:text-heading-100">
      <span>
    ...
    <div className="my-auto mb-20 mt-10 flex max-h-[230px] flex-col space-y-4 overflow-y-auto">
      ...
      <LangButton t={t} handleLinkClick={handleLinkClick} locale={fallbackLng} lang="korean" />
      <LangButton t={t} handleLinkClick={handleLinkClick} locale={secondLng} lang="english" />
